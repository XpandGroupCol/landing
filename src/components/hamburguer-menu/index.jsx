    ...
    <div className="lg:hidden">
      ...
      >
        ...
        <div className={`${menuOpen ? "flex " : "hidden"} top-0 left-0 fixed w-screen h-screen bg-red-500 z-50 flex-col `}>
           ...
           <svg   width="24" height="24" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinejoin="round" >
   <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
   ...
   <path d="M6 6l12 12"></path>
           ...
           <div className=" items-center gap-16 flex">
            <a href="#create-sherflow">
              <h3 className="font-ceraLight leading-[22.63px] text-[18px]">
                Paso a paso <span className="font-ceraBold">Campaña</span>
              </h3>
            </a>
            <a href="#benefits">
              <h3 className="leading-[22.63px] font-ceraLight text-[18px]">
