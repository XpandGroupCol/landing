    ...
    <>
      ...
      >
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="flex justify-center items-center sm:justify-end  gap-6 ">
            <button
              disabled={loading}
              className={`bg-fourth border-none text-[white]   uppercase px-2 py-1 font-semibold rounded-md ${
                loading ? "opacity-50" : ""
              }`}
            >
              Registrarme
